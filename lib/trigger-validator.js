...
class TriggerValidator {
  ...
  checkSpecificity(description) {
    ...
    const hasConcreteTerms = /\b(file|code|text|json|yaml|sql|api|http|git|npm|docker|css|html|javascript|python|markdown|csv|xml)\b/i.test(description);
  ...
  evaluateCrossLocale(frontmatter, userLocale) {
    ...
    const hasUniversalTerms = /\b(api|http|json|xml|html|css|javascript|python|sql|git|npm|docker|yaml|csv|url|uuid|id)\b/i.test(description);
